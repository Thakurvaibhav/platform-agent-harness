...
- Instance knowledge (cluster registries, account IDs, fleet inventories, "metric X does not exist" claims) never belongs in [`agent-knowledge/references/`](agent-knowledge/references/) — that tier is portable by definition. Here the instance tier ships as [`agent-knowledge/orgs/README.md`](agent-knowledge/orgs/README.md) and nothing else. Rule: [`core/protocols/knowledge-tiers.md`](core/protocols/knowledge-tiers.md).

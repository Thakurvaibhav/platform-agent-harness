...
Coding guidelines and engineering standards (Assumptions, Simplicity, Reuse-first, Surgical changes, **Comments**, Verification, Standing reflexes R1–R4) are the canonical content of [`code-quality.md`](code-quality.md). Every engineering sub-agent and the main session follows it. It is not restated here.
